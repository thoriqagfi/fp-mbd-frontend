    ...
    <>
      ...
      <Layout>
        {user?.role === 'Developer' ? (
            ...
            <div className='px-[20%] md:px-[15%]'>
              <div className='w-full py-10 px-16 flex flex-col lg:flex-row bg-slate-900'>
                <div className='w-full lg:w-2/3 flex flex-col lg:flex-row'>
                  <div className='w-full lg:w-1/3'>
                    <Image
                      ...
                      width={300}
                      alt='image2'
                      className='w-auto h-2/3 lg:h-full lg:w-auto mx-auto lg:mx-0 float-none lg:float-right'
                      src={user?.profile_image}
                    />
                  </div>
                  <div className='ml-0 lg:ml-10 mt-5 lg:mt-0 w-full lg:w-2/3 grid content-center'>
                    <p className='font-bold text-3xl mx-auto lg:mx-0'>
                      {user?.name}
                    </p>
                ...
                <div className='w-full lg:w-1/3 mt-5 lg:mt-0 grid content-center'>
                  <div className='flex flex-row items-center mx-auto lg:mx-0'>
                    <DeviceGamepad2 size={24} strokeWidth={2} color={'#ffff'} />
                    <p className='font-semibold text-xl ml-3'>
                      {data?.data.ListGames === undefined ||
                      data?.data.ListGames === null
                        ? 0
                        : data?.data.ListGames.length}
                    </p>
                    <p className='font-normal text-xl ml-2'>Released Games</p>
                  </div>
                  <div className='flex flex-row items-center mx-auto lg:mx-0 mt-5'>
                    <PlaylistAdd size={24} strokeWidth={2} color={'#ffff'} />
                    <p className='font-semibold text-xl ml-3'>
                      {data?.data.ListDLC === undefined ||
                      data?.data.ListDLC === null
                        ? 0
                        : data?.data.ListDLC.length}
                    </p>
                    <p className='font-normal text-xl ml-2'>Released DLC's</p>
                  </div>
              ...
              <div className='w-full mt-5 py-5 px-16 flex flex-col gap-10 xl:flex-row bg-slate-900'>
                ...
                <div className='w-full xl:w-1/2'>
                  ...
                  {data?.data.ListDLC === undefined ||
                  data?.data.ListDLC === null ? (
                    <p>This developer hasn't released any DLC's</p>
                  ) : (
                    data?.data.ListDLC.map((item) => (
                      <div className='flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row w-full dark:border-gray-700 dark:bg-gray-800 mb-3'>
                        <Image
                          height={500}
                          width={500}
              ...
              <div className='w-full py-10 px-16 flex flex-col lg:flex-row bg-slate-900'>
                ...
                <div className='w-full lg:w-1/3 mt-5 lg:mt-0 grid content-center'>
                  <div className='flex flex-row items-center mx-auto lg:mx-0'>
                    <DeviceGamepad2 size={24} strokeWidth={2} color={'#ffff'} />
                    <p className='font-semibold text-xl ml-3'>
                      {user?.list_game === undefined
                        ? 0
                        : user?.list_game.length}
                    </p>
                    <p className='font-normal text-xl ml-2'>Owned Games</p>
                  </div>
                  <div className='flex flex-row items-center mx-auto lg:mx-0 mt-5'>
                    <PlaylistAdd size={24} strokeWidth={2} color={'#ffff'} />
                    <p className='font-semibold text-xl ml-3'>
                      {user?.list_dlc === undefined ? 0 : user?.list_dlc.length}
                    </p>
                    <p className='font-normal text-xl ml-2'>Owned DLC's</p>
                  </div>
                </div>
              </div>
              <div className='w-full mt-5 py-5 px-16 flex flex-col gap-10 xl:flex-row bg-slate-900'>
                ...
                <div className='w-full xl:w-1/2'>
                  ...
                  {user?.list_dlc === undefined ? (
                    <p>This user has no DLC's</p>
                  ) : (
                    user?.list_dlc.map((item) => (
                      <div className='flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row w-full dark:border-gray-700 dark:bg-gray-800 mb-3'>
                        <Image
                          height={500}
                          width={500}
          ...
          <main className='bg-blue-200 dark:bg-slate-800 py-12 h-[calc(100vh-90px)] flex justify-center'>
            <p className='my-auto'>Please Login to reveal profile</p>
          </main>
        )}
      </Layout>
    </>
