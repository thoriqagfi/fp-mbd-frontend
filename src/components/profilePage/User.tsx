                    ...
                    <div className="w-full py-10 px-16 flex flex-col lg:flex-row bg-slate-900">
                        <div className="w-full lg:w-2/3 flex flex-col lg:flex-row">
                            ...
                            <div className="ml-0 lg:ml-10 mt-5 lg:mt-0 w-full lg:w-2/3 grid content-center">
                                <p className="font-bold text-3xl mx-auto lg:mx-0">Abay</p>
                                <p className="mt-2 font-normal text-xl mx-auto lg:mx-0">Abay@gmail.com</p>
                            </div>
                        </div>
                        <div className="w-full lg:w-1/3 mt-5 lg:mt-0 grid content-center">
                            <div className="flex flex-row items-center mx-auto lg:mx-0">
                                <DeviceGamepad2 size={24} strokeWidth={2} color={'#ffff'}/><p className="font-semibold text-xl ml-3">10</p><p className="font-normal text-xl ml-2">Owned Games</p><p className="font-normal text-xl ml-2">Released Games</p>
                            </div>
                            <div className="flex flex-row items-center mx-auto lg:mx-0 mt-5">
                                <PlaylistAdd size={24} strokeWidth={2} color={'#ffff'}/><p className="font-semibold text-xl ml-3">10</p><p className="font-normal text-xl ml-2">Owned DLC's</p><p className="font-normal text-xl ml-2">Released DLC's</p>
                            </div>
                        </div>
                    </div>
                    <div className="w-full mt-5 py-5 px-16 flex flex-col gap-10 xl:flex-row bg-slate-900">
                        <div className="w-full xl:w-1/2">
                            <p className="font-normal text-xl ml-2 my-5">Owned Games</p><p className="font-normal text-xl ml-2 my-5">Released Games</p>
                        ...
                        <div className="w-full xl:w-1/2">
                        <p className="font-normal text-xl ml-2 my-5">Owned DLC's</p><p className="font-normal text-xl ml-2 my-5">Released DLC's</p>
